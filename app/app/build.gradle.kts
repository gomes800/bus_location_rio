...
android {
    namespace = "com.example.bus_location_rio"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.bus_location_rio"
        minSdk = 28
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.play.services.maps) // Play Services Maps
    ...
    implementation(libs.ui) // Verifique se essa dependência está correta no seu contexto
